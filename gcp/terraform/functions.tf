resource "google_cloudfunctions_function" "stackdriver2slack" {
  ...
  source_repository {
    url = "https://source.developers.google.com/projects/${var.project}/repos/github_i-pu_ipu/fixed-aliases/stackdriver2slack-tag/paths/gcp/functions/stackdriver2slack"
  }
