...
var author$project$Components$Url$Error404 = function (a) {
	return {$: 'Error404', a: a};
};
var author$project$Components$Url$Marketpage = {$: 'Marketpage'};
var author$project$Components$Url$fromString = function (url) {
	if (url === '') {
		return author$project$Components$Url$Marketpage;
	} else {
		return author$project$Components$Url$Error404(url);
	}
};
...
var author$project$Components$Url$fromUrl = function (url) {
	return author$project$Components$Url$fromString(
...
var author$project$Components$Market$defaultModel = {errorMessage: '', mdc: author$project$Material$defaultModel, packages: _List_Nil};
var author$project$Main$defaultModel = function (key) {
	return {key: key, market: author$project$Components$Market$defaultModel, mdc: author$project$Material$defaultModel, url: author$project$Components$Url$Marketpage};
};
	...
	function (_n0, url, key) {
		...
		return _Utils_Tuple2(
			_Utils_update(
				initialModel,
				{
					url: author$project$Components$Url$fromUrl(url)
				}),
...
var author$project$Components$Market$Mdc = function (a) {
	return {$: 'Mdc', a: a};
};
			...
			switch (_n0.a.$) {
				...
				case 'Activate':
					if (_n0.a.b.$ === 'Err') {
						...
						var element = _n10.b.a.element;
						var viewport = _n10.b.a.viewport;
						var newAnimationCounter = model.animationCounter + 1;
						var _n11 = A4(author$project$Internal$Ripple$Implementation$animateActivation, activateData.isUnbounded, element, viewport, activateData.event);
						var translateStart = _n11.translateStart;
						var translateEnd = _n11.translateEnd;
						var _n12 = A2(author$project$Internal$Ripple$Implementation$layoutInternal, activateData.isUnbounded, element);
						var fgScale = _n12.fgScale;
						var initialSize = _n12.initialSize;
						var activatedData = {
...
var author$project$Components$Market$update = F3(
	function (lift, msg, model) {
		var msg_ = msg.a;
		return A3(
			author$project$Material$update,
			A2(elm$core$Basics$composeL, lift, author$project$Components$Market$Mdc),
			msg_,
			model);
	});
var author$project$Components$Url$toString = function (url) {
	if (url.$ === 'Marketpage') {
		return '#';
	} else {
...
var author$project$Main$MarketMsg = function (a) {
	return {$: 'MarketMsg', a: a};
};
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								model.key,
								author$project$Components$Url$toString(url))
							])));
			case 'UrlRequested':
				if (msg.a.$ === 'Internal') {
					var url = msg.a.a;
					return _Utils_Tuple2(
						...
						elm$browser$Browser$Navigation$load(
							author$project$Components$Url$toString(
								author$project$Components$Url$fromUrl(url))));
				} else {
					var string = msg.a.a;
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			...
			default:
				var msg_ = msg.a;
				var _n1 = A3(author$project$Components$Market$update, author$project$Main$MarketMsg, msg_, model.market);
				var market = _n1.a;
				var effects = _n1.b;
				return _Utils_Tuple2(
					_Utils_update(
...
var author$project$Components$Market$demoIcon = _List_fromArray(
	[
		A2(author$project$Material$Options$css, 'background', 'rgba(0,0,0,.3)'),
		A2(author$project$Material$Options$css, 'border-radius', '50%'),
		A2(author$project$Material$Options$css, 'color', '#fff')
	]);
...
var author$project$Internal$List$Implementation$defaultConfig = {isRadioGroup: false, isSingleSelectionList: false, node: elm$core$Maybe$Nothing, onSelectListItem: elm$core$Maybe$Nothing, selectedIndex: elm$core$Maybe$Nothing, useActivated: false};
...
var author$project$Internal$List$Implementation$liView = F8(
	function (domId, lift, model, config, listItemIds, index, options, children) {
		var selected_index = A2(elm$core$Maybe$withDefault, 0, config.selectedIndex);
		...
		var tab_index = _Utils_eq(focused_index, index) ? 0 : (-1);
		return A5(
			author$project$Internal$Options$apply,
			li_summary,
			...
			_List_fromArray(
				[
					...
					A2(author$project$Internal$Options$when, config.isSingleSelectionList && (is_selected && config.useActivated), author$project$Internal$List$Implementation$activated),
					A2(
					author$project$Internal$Options$when,
					config.isRadioGroup,
					A2(
...
var author$project$Internal$List$Implementation$listItemView = F7(
	function (domId, lift, model, config, listItemsIds, index, li_) {
		return A8(li_.view, domId, lift, model, config, listItemsIds, index, li_.options, li_.children);
	});
...
var author$project$Components$Market$viewPackages = F3(
		...
		return A5(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2(author$project$Material$List$graphicIcon, author$project$Components$Market$demoIcon, 'folder'),
							A2(
...
var author$project$Components$Page$pages = function (nodes) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		A2(
...
var author$project$Components$Market$view = F3(
	function (lift, page, model) {
		return A3(
			...
			_List_fromArray(
				[
					author$project$Components$Page$pages(
					_List_fromArray(
						[
							A3(author$project$Components$Market$viewPackages, lift, model, 'sample')
						]))
				]));
	});
...
var author$project$Main$view_ = function (model) {
	var page = {
		body: F3(
			function (title, intro, nodes) {
				return A2(elm$html$Html$div, _List_Nil, nodes);
			}),
		navigate: author$project$Main$Navigate
	};
	var _n0 = model.url;
	if (_n0.$ === 'Marketpage') {
		return A3(author$project$Components$Market$view, author$project$Main$MarketMsg, page, model.market);
	} else {
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Material.Msg":{"args":["m"],"type":"Internal.Msg.Msg m"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Internal.Index.Index":{"args":[],"type":"String.String"},"Internal.Menu.Model.Geometry":{"args":[],"type":"{ viewport : Internal.Menu.Model.Viewport, viewportDistance : Internal.Menu.Model.ViewportDistance, anchor : { width : Basics.Float, height : Basics.Float }, menu : { width : Basics.Float, height : Basics.Float } }"},"Internal.Menu.Model.Key":{"args":[],"type":"String.String"},"Internal.Menu.Model.KeyCode":{"args":[],"type":"Basics.Int"},"Internal.Menu.Model.Meta":{"args":[],"type":"{ altKey : Basics.Bool, ctrlKey : Basics.Bool, metaKey : Basics.Bool, shiftKey : Basics.Bool }"},"Internal.Menu.Model.Viewport":{"args":[],"type":"{ width : Basics.Float, height : Basics.Float }"},"Internal.Menu.Model.ViewportDistance":{"args":[],"type":"{ top : Basics.Float, right : Basics.Float, left : Basics.Float, bottom : Basics.Float }"},"Internal.Ripple.Model.ActivateData":{"args":[],"type":"{ event : Internal.Ripple.Model.Event, isSurfaceDisabled : Basics.Bool, wasElementMadeActive : Basics.Bool, isUnbounded : Basics.Bool }"},"Internal.Ripple.Model.ClientRect":{"args":[],"type":"{ top : Basics.Float, left : Basics.Float, width : Basics.Float, height : Basics.Float }"},"Internal.Ripple.Model.Event":{"args":[],"type":"{ eventType : String.String, pagePoint : { pageX : Basics.Float, pageY : Basics.Float } }"},"Internal.Slider.Model.Geometry":{"args":[],"type":"{ rect : Internal.Slider.Model.Rect, discrete : Basics.Bool, step : Maybe.Maybe Basics.Float, min : Basics.Float, max : Basics.Float }"},"Internal.Slider.Model.Rect":{"args":[],"type":"{ left : Basics.Float, width : Basics.Float }"},"Internal.TabBar.Model.Geometry":{"args":[],"type":"{ tabs : List.List Internal.TabBar.Model.Tab, scrollArea : { offsetWidth : Basics.Float }, tabBar : { offsetWidth : Basics.Float } }"},"Internal.TabBar.Model.Tab":{"args":[],"type":"{ offsetLeft : Basics.Float, offsetWidth : Basics.Float, contentLeft : Basics.Float, contentRight : Basics.Float }"},"Internal.TextField.Model.Geometry":{"args":[],"type":"{ width : Basics.Float, height : Basics.Float, labelWidth : Basics.Float }"},"Internal.Toolbar.Model.Config":{"args":[],"type":"{ fixed : Basics.Bool, fixedLastrow : Basics.Bool, fixedLastRowOnly : Basics.Bool, flexible : Basics.Bool, useFlexibleDefaultBehavior : Basics.Bool, waterfall : Basics.Bool, backgroundImage : Maybe.Maybe String.String }"},"Internal.Toolbar.Model.Geometry":{"args":[],"type":"{ getRowHeight : Basics.Float, getFirstRowElementOffsetHeight : Basics.Float, getOffsetHeight : Basics.Float }"},"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"}},"unions":{"Main.Msg":{"args":[],"tags":{"Mdc":["Material.Msg Main.Msg"],"Navigate":["Components.Url.Url"],"UrlRequested":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"MarketMsg":["Components.Market.Msg Main.Msg"]}},"Components.Market.Msg":{"args":["m"],"tags":{"Mdc":["Material.Msg m"]}},"Components.Url.Url":{"args":[],"tags":{"Marketpage":[],"Error404":["String.String"]}},"Internal.Msg.Msg":{"args":["m"],"tags":{"Dispatch":["List.List m"],"ButtonMsg":["Internal.Index.Index","Internal.Button.Model.Msg m"],"CheckboxMsg":["Internal.Index.Index","Internal.Checkbox.Model.Msg"],"ChipMsg":["Internal.Index.Index","Internal.Chip.Model.Msg m"],"DialogMsg":["Internal.Index.Index","Internal.Dialog.Model.Msg"],"DrawerMsg":["Internal.Index.Index","Internal.Drawer.Model.Msg"],"FabMsg":["Internal.Index.Index","Internal.Fab.Model.Msg"],"IconButtonMsg":["Internal.Index.Index","Internal.IconButton.Model.Msg"],"ListMsg":["Internal.Index.Index","Internal.List.Model.Msg m"],"MenuMsg":["Internal.Index.Index","Internal.Menu.Model.Msg m"],"RadioButtonMsg":["Internal.Index.Index","Internal.RadioButton.Model.Msg"],"RippleMsg":["Internal.Index.Index","Internal.Ripple.Model.Msg"],"SelectMsg":["Internal.Index.Index","Internal.Select.Model.Msg m"],"SliderMsg":["Internal.Index.Index","Internal.Slider.Model.Msg m"],"SnackbarMsg":["Internal.Index.Index","Internal.Snackbar.Model.Msg m"],"SwitchMsg":["Internal.Index.Index","Internal.Switch.Model.Msg"],"TabBarMsg":["Internal.Index.Index","Internal.TabBar.Model.Msg m"],"TextFieldMsg":["Internal.Index.Index","Internal.TextField.Model.Msg"],"ToolbarMsg":["Internal.Index.Index","Internal.Toolbar.Model.Msg"],"TopAppBarMsg":["Internal.Index.Index","Internal.TopAppBar.Model.Msg"]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Internal.Button.Model.Msg":{"args":["m"],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"Click":["Basics.Bool","m"]}},"Internal.Checkbox.Model.Msg":{"args":[],"tags":{"NoOp":[],"Init":["Maybe.Maybe (Maybe.Maybe Internal.Checkbox.Model.State)","Maybe.Maybe Internal.Checkbox.Model.State"],"SetFocus":["Basics.Bool"],"AnimationEnd":[]}},"Internal.Chip.Model.Msg":{"args":["m"],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"Click":["m"]}},"Internal.Dialog.Model.Msg":{"args":[],"tags":{"NoOp":[],"StartAnimation":["Basics.Bool"],"EndAnimation":[]}},"Internal.Drawer.Model.Msg":{"args":[],"tags":{"NoOp":[],"StartAnimation":["Basics.Bool"],"EndAnimation":[]}},"Internal.Fab.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"NoOp":[]}},"Internal.IconButton.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"]}},"Internal.List.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"RippleMsg":["String.String","Internal.Ripple.Model.Msg"],"FocusItem":["Basics.Int","String.String"],"ResetFocusedItem":[],"SelectItem":["Basics.Int","Basics.Int -> m"]}},"Internal.Menu.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"Init":["{ quickOpen : Basics.Bool, index : Maybe.Maybe Basics.Int }","Internal.Menu.Model.Geometry"],"AnimationEnd":[],"Open":[],"Close":[],"Toggle":[],"CloseDelayed":[],"DocumentClick":[],"KeyDown":["Basics.Int","Internal.Menu.Model.Meta","Internal.Menu.Model.Key","Internal.Menu.Model.KeyCode"],"KeyUp":["Internal.Menu.Model.Meta","Internal.Menu.Model.Key","Internal.Menu.Model.KeyCode"],"SetFocus":["Basics.Int"]}},"Internal.RadioButton.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"NoOp":[],"SetFocus":["Basics.Bool"]}},"Internal.Ripple.Model.Msg":{"args":[],"tags":{"Focus":[],"Blur":[],"Activate0":["String.String","Internal.Ripple.Model.ActivateData"],"Activate":["Internal.Ripple.Model.ActivateData","Result.Result Browser.Dom.Error Browser.Dom.Element"],"Reactivate":["Internal.Ripple.Model.ActivateData","Result.Result Browser.Dom.Error Browser.Dom.Element"],"ActivationEnded":["Basics.Int"],"Deactivate":[],"DeactivationEnded":["Basics.Int"],"SetCssVariables":["Basics.Bool","Internal.Ripple.Model.ClientRect"]}},"Internal.Select.Model.Msg":{"args":["m"],"tags":{"Blur":[],"Focus":[],"Change":["String.String"],"RippleMsg":["Internal.Ripple.Model.Msg"]}},"Internal.Slider.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"Init":["Internal.Slider.Model.Geometry"],"Resize":["Internal.Slider.Model.Geometry"],"InteractionStart":["String.String","{ pageX : Basics.Float }"],"KeyDown":[],"Focus":[],"Blur":[],"ThumbContainerPointer":["String.String","{ pageX : Basics.Float }"],"TransitionEnd":[],"Drag":["{ pageX : Basics.Float }"],"Up":[],"ActualUp":[]}},"Internal.Snackbar.Model.Msg":{"args":["m"],"tags":{"Move":["Basics.Int","Internal.Snackbar.Model.Transition"],"Dismiss":["Basics.Bool","Maybe.Maybe m"],"SetOpen":[]}},"Internal.Switch.Model.Msg":{"args":[],"tags":{"RippleMsg":["Internal.Ripple.Model.Msg"],"SetFocus":["Basics.Bool"],"NoOp":[]}},"Internal.TabBar.Model.Msg":{"args":["m"],"tags":{"NoOp":[],"Dispatch":["List.List m"],"RippleMsg":["Basics.Int","Internal.Ripple.Model.Msg"],"Init":["Internal.TabBar.Model.Geometry"],"SetActiveTab":["String.String","Basics.Int","Basics.Float"]}},"Internal.TextField.Model.Msg":{"args":[],"tags":{"Blur":[],"Focus":["Internal.TextField.Model.Geometry"],"Input":["String.String"],"NoOp":[]}},"Internal.Toolbar.Model.Msg":{"args":[],"tags":{"Init":["Internal.Toolbar.Model.Config","Internal.Toolbar.Model.Geometry"],"Resize":["Internal.Toolbar.Model.Config","Internal.Toolbar.Model.Geometry"],"Scroll":["Internal.Toolbar.Model.Config","Basics.Float"]}},"Internal.TopAppBar.Model.Msg":{"args":[],"tags":{"RippleMsg":["String.String","Internal.Ripple.Model.Msg"],"Init":["{ scrollPosition : Basics.Float, topAppBarHeight : Basics.Float }"],"Resize":["{ scrollPosition : Basics.Float, topAppBarHeight : Basics.Float }"],"Scroll":["{ scrollPosition : Basics.Float }"]}},"List.List":{"args":["a"],"tags":{}},"Internal.Checkbox.Model.State":{"args":[],"tags":{"Checked":[],"Unchecked":[]}},"Internal.Snackbar.Model.Transition":{"args":[],"tags":{"Timeout":[],"Clicked":[]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}}}})}});
